...
{{< image
src="donquixote1.png"
descr="Inverted-scale original images (top row) and psf-subtracted images (bottom row) for Don Quixote and a similarly bright calibration star."
>}}
...
{{< image
src="donquixote2.png"
descr="Radial brightness profile plots from our Spitzer observations."
>}}
...
description="Extended emission around Don Quixote, including a faint tail pointing away from the Sun."
>}}
...
Please note that in 2020 we found again activity in Don Quixote, revealing the recurrent nature of its activity. See [here]({{< ref "research/2020-05-07-don-quixote-and-the-dormant-comets-my-astronomical-legacy">}}) for details.
